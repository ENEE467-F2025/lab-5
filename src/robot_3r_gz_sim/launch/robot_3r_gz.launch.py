...
def generate_launch_description():
    ...
    return LaunchDescription(declared_arguments + [
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments=[("gz_args", "default.sdf -v 3 -r -s --physics-engine gz-physics-bullet-plugin")],
        ),
        # Start Gazebo (non-headless)
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                PathJoinSubstitution([
                    FindPackageShare("ros_gz_sim"),
            ...
            launch_arguments=[("gz_args", "default.sdf -v 3 -r --physics-engine gz-physics-bullet-plugin")],
        ),
